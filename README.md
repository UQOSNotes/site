...
## Contributing
This site is built with eleventy. To build locally, clone the repository and run `npm install` to install dependencies, then `npm run build` to build the site. To serve the site locally, run `npm run serve` and navigate to http://localhost:8080 in your web browser. 
